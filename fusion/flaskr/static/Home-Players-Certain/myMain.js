...
services.factory("Player", [
    "$resource",
    function (a) {
        return a("./../static/Home-Players-Certain/api/players.php?player=:playerId", {}, {
            query: {
                cache: !0,
                method: "GET",
                params: {
...
services.factory("Shots", [
    "$resource",
    function (a) {
        return a("./../static/Home-Players-Certain/api/shoot.php?player=:playerId", {}, {
            query: {
                cache: !0,
                method: "GET",
                params: {
...
services.factory("ShotAverages", [
    "$resource",
    function (a) {
        return a("./../static/Home-Players-Certain/api/shot_average.php", {}, {
            query: {
                cache: !0,
                method: "GET",
                params: {
...
services.factory("PlayerGameStats", [
    "$resource",
    function (a) {
        return a("./../static/Home-Players-Certain/api/player_game_stats.php?player=:playerId", {}, {
            query: {
                cache: !0,
                method: "GET",
                params: {
...
services.factory("NearRanks", [
    ...
    function (a) {
        ...
        return a("./../static/Home-Players-Certain/api/player_near_ranks.php?player=:playerId", {}, {
            query: {
                cache: !0,
                method: "GET",
                params: {
...
services.factory("VsTeam", [
    ...
    "$resource",
    function (a, b) {
        return b("./../static/Home-Players-Certain/api/vs_team_stats.php", {}, {
            query: {
                cache: !0,
                method: "GET",
                params: {
...
services.factory("ReportPlayers", [
    ...
    function (a) {
        return a(
            "./../static/Home-Players-Certain/api/report_players.php?season=:season&numPlayers=:numPlayers",
            {},
            {
                query: {
                    cache: !0,
    ...
    .config([
        ...
        function (a) {
            a.when("/playerView/:playerId", {
                templateUrl: "../static/Home-Players-Certain/pages/playerView/playerView.html",
...
angular
    ...
    .directive("pbShotChartFilters", [
        ...
        function (a) {
            return {
                restrict: "E",
                templateUrl: "../static/Home-Players-Certain/components/shotChart/shotChartFilters.html",
                scope: {
                    filters: "=model",
                    countMax: "@",
                    countClampMax: "@",
...
angular
    ...
    .directive("pbShotChartHeatmapFilters", [
        function () {
            return {
                restrict: "E",
                templateUrl: "../static/Home-Players-Certain/components/shotChart/shotChartHeatmapFilters.html",
                scope: {
                    filters: "=model",
                    countMax: "@",
                    countClampMax: "@",
...
angular
    ...
    .directive("pbSignature", [
        ...
        function (a, b) {
            ...
            return {
                restrict: "E",
                template: '<div><div class="signature-explanation-toggle">?<img src="../static/Home-Players-Certain/img/signature_explan' +
...
angular
    ...
    .directive("pbRanks", [
        function () {
            return {
                restrict: "E",
                templateUrl: "../static/Home-Players-Certain/components/ranks/ranks.html",
                scope: {
                    stat: "@",
                    rankName: "@",
                    label: "@",
...
angular
    ...
    .directive("pbPlayerSelector", [
        ...
        function (a, b) {
            return {
                restrict: "E",
                templateUrl: "../static/Home-Players-Certain/components/playerSelector/playerSelector.html",
                scope: {
                    setPlayer: "=",
                    season: "="
                },
    ...
    .directive("pbGameSelector", [
        ...
        function (a) {
            ...
            return {
                ...
                templateUrl: "../static/Home-Players-Certain/components/gameSelector/gameSelector.html",
                link: function (a) {
